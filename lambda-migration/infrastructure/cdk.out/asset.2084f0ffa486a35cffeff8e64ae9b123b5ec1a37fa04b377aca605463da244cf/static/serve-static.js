            ...
            try {
                ...
                return {
                    ...
                    headers: {
                        ...
                        // Include additional debug headers for troubleshooting
                        'X-Debug-Path': filePath,
                        'X-Debug-Domain': cdnUtils.CLOUDFRONT_DOMAIN,
                        'X-Debug-Stage': process.env.STAGE || 'unknown'
                    }
                };
            } catch (error) {
                console.warn(`Failed to generate CloudFront URL, serving directly: ${error.message}`);
                // If generating the CloudFront URL fails, we'll continue to serve directly
            }
        }
