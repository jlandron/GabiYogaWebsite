...
// Set the CloudFront domain based on environment variable or fallback to custom domain
// We're temporarily using the default CloudFront domain until custom domain is set up
const CLOUDFRONT_DOMAIN = process.env.CLOUDFRONT_DOMAIN || (
  stage === 'prod'
    ? 'd4zemfu4barbq.cloudfront.net' // Replace with your actual CloudFront domain
    : 'd4zemfu4barbq.cloudfront.net'  // Replace with your actual CloudFront domain
);
