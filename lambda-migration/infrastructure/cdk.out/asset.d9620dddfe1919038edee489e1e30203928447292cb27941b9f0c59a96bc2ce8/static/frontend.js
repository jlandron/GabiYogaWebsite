...
function renderCalendar() {
    ...
    for (let i = 0; i < 28; i++) {
        ...
        // Get the date string in YYYY-MM-DD format for lookup in calendarClasses
        const dayStr = currentDay.toISOString().split('T')[0];
        
        // Fix for the off-by-one day issue: we need to look up classes scheduled for this day
        // The backend expects the correct date but there's a mismatch in rendering
