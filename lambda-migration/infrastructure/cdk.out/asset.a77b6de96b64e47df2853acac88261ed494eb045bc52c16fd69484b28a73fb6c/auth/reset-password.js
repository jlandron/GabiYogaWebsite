...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Use empty string instead of null for resetToken to satisfy GSI requirements
    const updatedUser = {
      ...user,
      password: hashedPassword,
      resetToken: "",  // Use empty string instead of null to work with GSI
      resetTokenExpiry: "",  // Use empty string instead of null to be consistent
